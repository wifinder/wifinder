...
import com.wifinder.client.MyRequestFactory.HelloWorldRequest;
import com.wifinder.client.MyRequestFactory.MessageRequest;
import com.wifinder.shared.MessageProxy;

public class WiFinderWidget extends Composite {
  ...
  interface WiFinderUiBinder extends UiBinder<Widget, WiFinderWidget> {
  }

  private static WiFinderUiBinder uiBinder = GWT.create(WiFinderUiBinder.class);
